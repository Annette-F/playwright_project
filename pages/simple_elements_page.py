...
class SimpleElementsPage:
    ...
    @allure.step('ПРоверка радио-кнопки "female"')
    ...
    @allure.step('Проверка чекбокса "Bike"')
    def select_bike_checkbox(self):
        self.page.click(self.bike_checkbox)

    @allure.step('Выбор автомодиля: {value}')
    ...
    @allure.step('Проверка текста в ячейке таблицы')
